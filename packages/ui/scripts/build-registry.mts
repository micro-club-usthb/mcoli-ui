...
export const Index: Record<string, any> ={`;
  ...
  "${item.name}": {
    ...
    const sourceContent =
      item.type === 'registry:example' ? await fs.readFile(sourcePath, 'utf-8') : '';
