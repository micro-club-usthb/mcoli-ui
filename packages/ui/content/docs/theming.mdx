...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']}>
  <Tab>```sh npx mcoli-ui@latest init ```</Tab>
  <Tab>```sh pnpm dlx mcoli-ui@latest init ```</Tab>
  <Tab>```sh yarn dlx mcoli-ui@latest init ```</Tab>
  <Tab>```sh bunx mcoli-ui@latest init ```</Tab>
</Tabs>
...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']}>
  <Tab>```sh npx mcoli-ui@latest init primary ```</Tab>
  <Tab>```sh pnpm dlx mcoli-ui@latest init primary ```</Tab>
  <Tab>```sh yarn dlx mcoli-ui@latest init primary ```</Tab>
  <Tab>```sh bunx mcoli-ui@latest init primary ```</Tab>
</Tabs>
...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']}>
  <Tab>```sh npx mcoli-ui@latest init secondary ```</Tab>
  <Tab>```sh pnpm dlx mcoli-ui@latest init secondary ```</Tab>
  <Tab>```sh yarn dlx mcoli-ui@latest init secondary ```</Tab>
  <Tab>```sh bunx mcoli-ui@latest init secondary ```</Tab>
</Tabs>
