...
const commonThemeVars = {
  ...
  "--color-mint-green": "var(--mint-green)",
  "--color-teal-green": "var(--teal-green)",
  "--color-teal": "var(--teal)",
  "--color-golden-sun": "var(--golden-sun)",
  "--color-sunset-orange": "var(--sunset-orange)",
  "--color-rose-pink": "var(--rose-pink)",
  "--color-indigo-blue": "var(--indigo-blue)",
  "--color-amber-mustard": "var(--amber-mustard)",
...
export { commonCSS, commonThemeVars, commonLightVars, commonDarkVars };
